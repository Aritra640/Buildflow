  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-16 bg-gradient-to-br from-[#0b0b0b] via-[#1c1c1c] to-[#0a0a0a] text-white text-center">
      <div className="max-w-xl">
        <h1 className="text-4xl sm:text-5xl font-extrabold mb-6 text-pink-500">🚧 Feature Coming Soon!</h1>
        <p className="text-lg sm:text-xl mb-4">
          Hello <span className="font-semibold">{user}</span>, thank you for your interest.
        </p>
        <p className="text-base mb-6">
          The WatchList feature is currently under development. We'll notify you at <span className="font-semibold">{email}</span> when it's ready to use.
        </p>
        <p className="text-base mb-6">
          Meanwhile, you can check out the live demo to explore how BuildFlow empowers global manufacturing.
        </p>
        <button
